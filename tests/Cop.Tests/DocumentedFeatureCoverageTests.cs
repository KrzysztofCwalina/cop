...
public class DocumentedFeatureCoverageTests
{
    private static readonly IReadOnlyDictionary<string, FeatureCoverage> FeatureClassifications =
        new Dictionary<string, FeatureCoverage>(StringComparer.Ordinal)
        {
            ...
            ["Average"] = NotYetCovered("No focused execution test for Average aggregation yet"),
            ["concat"] = NotYetCovered("Intrinsic function form is documented but not directly executed"),
            ["contains"] = CoveredBy("CodebaseModelPopulationTests"),
            ["containsAny"] = CoveredBy("doc-samples"),
            ["containsKey"] = NotYetCovered("Object key predicate has no active focused execution test yet"),
            ...
            ["error"] = NotYetCovered("Operational error constructor has no active execution test yet"),
            ["fail"] = NotYetCovered("Fatal diagnostic intrinsic has no active focused execution test yet"),
            ["First"] = CoveredBy("doc-samples"),
            ["Get"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["greaterOrEqual"] = NotYetCovered("Numeric greater-or-equal predicate has no active focused execution test yet"),
            ["greaterThan"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["GroupBy"] = NotYetCovered("GroupBy transform has no active focused execution test yet"),
            ["in"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["isClear"] = CoveredBy("CodebaseModelPopulationTests"),
            ["isError"] = NotYetCovered("Error filtering predicate has no active execution test yet"),
            ...
            ["lessOrEqual"] = NotYetCovered("Numeric less-or-equal predicate has no active focused execution test yet"),
            ["lessThan"] = NotYetCovered("Numeric less-than predicate has no active focused execution test yet"),
            ["Lower"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["matches"] = CoveredBy("CodebaseModelPopulationTests"),
            ["Matches"] = NotYetCovered("Documented built-in alias has no active focused execution test yet"),
            ["Max"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["Min"] = NotYetCovered("Min aggregation has no active focused execution test yet"),
            ["none"] = CoveredBy("doc-samples"),
            ["Normalized"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["notEquals"] = NotYetCovered("notEquals predicate has no active focused execution test yet"),
            ["OrderBy"] = CoveredBy("doc-samples"),
            ["OrderByDescending"] = CoveredBy("doc-samples"),
            ["Path"] = NotYetCovered("Documented Path alias has no active focused execution test yet"),
            ["pathMatches"] = NotYetCovered("Glob matching intrinsic has no active focused execution test yet"),
            ...
            ["Reduce"] = NotYetCovered("Documented collection Reduce transform has no active focused execution test yet"),
            ["reduce"] = NotYetCovered("Intrinsic reduce function has no active focused execution test yet"),
            ["Replace"] = NotYetCovered("String Replace transform has no active focused execution test yet"),
            ["sameAs"] = NotYetCovered("Convention-insensitive string predicate has no active focused execution test yet"),
            ...
            ["Text"] = NotYetCovered("Documented Text alias has no active focused execution test yet"),
            ["Trim"] = NotYetCovered("String Trim transform has no active focused execution test yet"),
            ["Upper"] = CoveredBy("LanguageFeatureExecutionTests"),
            ["Values"] = NotYetCovered("Object Values property has no active focused execution test yet"),
