...
name: csharp
version: 1.0.0
title: C# Source Language Provider
description: C# source code parser and analyzer
authors: cop-team
tags: csharp, dotnet
provider: clr
...
Run cop with the `csharp-lister` package to compare current code against the baseline.
