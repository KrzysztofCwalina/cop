...
Azure-specific client library patterns. Builds on `csharp-library-client` with Azure.Core or System.ClientModel pipeline integration and required TokenCredential authentication. Includes Azure.ClientSdk.Analyzers.
