...
Design patterns for building .NET client libraries. Covers constructor conventions, retry policies, pagination, long-running operations, and response types. Includes CLIENT001-003 Roslyn analyzer checks.
